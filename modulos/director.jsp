...
<ul class="modo">
    ...
    <!-- Submodulo de solicitudes de baja -->
    <li><a id="s11" onclick="javascript:eAjax(19, 'director')" href="" rel="submodulo19">Solicitudes de baja</a></li>
    ...
    <div class="cargando">
        ...
        <div class="submodulo" style="display:none" id="submodulo13" >
            ...
            <div class="submodulo" style="display:none" id="submodulo18" >
                ...
                <!-- submodulo 19 SOLICITUDES DE BAJA -->
