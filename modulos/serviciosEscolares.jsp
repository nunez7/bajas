...
<ul class="modo">
    ...
    <li><a id="s8" onclick="javascript:eAjax(8, 'escolares')" href="" rel="submodulo8">Solicitudes de baja</a></li>
    <li><a id="s9" onclick="javascript:eAjax(9, 'escolares')" href="" rel="submodulo9">Reporte de bajas</a></li>
</ul>
...
<!-- Submodulo 8 solicitudes de baja -->
<div class="submodulo" style="display:none" id="submodulo8">
    <div class="cargando"><img title="Cargando" align="Cargando" src="<%=Configuracion.URL_TEMA%>imagenes/cargando.gif" /></div>
</div>

<!-- Submodulo 9 reporte de bajas de alumnos -->
